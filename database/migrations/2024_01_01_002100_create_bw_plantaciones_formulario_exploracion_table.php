...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('bw_plantaciones_formulario_exploracion', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->index('cod_plantacion', 'fk_bw_plantaciones_formulario_exploracion_bw_plantaciones_idx');
            $table->index('user_insert', 'fk_bw_plantaciones_formulario_exploracion_usu_usuarios_idx');

            $table->foreign('cod_plantacion', 'fk_bw_plantaciones_formulario_exploracion_bw_plantaciones')->references('cod_plantacion')->on('bw_plantaciones');
            $table->foreign('user_insert', 'fk_bw_plantaciones_formulario_exploracion_usu_usuarios')->references('cod_usuario')->on('usu_usuarios');
        });
    ...
    {
        Schema::disableForeignKeyConstraints();
        Schema::dropIfExists('bw_plantaciones_formulario_exploracion');
        Schema::enableForeignKeyConstraints();
    }
};
