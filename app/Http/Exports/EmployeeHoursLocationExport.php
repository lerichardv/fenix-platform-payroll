...
class EmployeeHoursLocationExport implements
    FromView,
    ShouldAutoSize,
    WithBackgroundColor,
    WithStyles
{
    ...
    {
        $controller = new ReporteEmployeeHoursLocationController();
        return view('admin.reportes.exports.employee_hours_location_export', [
            'usuarios' => $controller->generarReporteUsuariosConsolidado(
                $this->initial_date,
                $this->final_date,
                $this->cod_farm,
                $this->cod_location,
