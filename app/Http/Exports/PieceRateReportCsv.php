...
class PieceRateReportCsv implements
    FromView,
    ShouldAutoSize,
    WithBackgroundColor,
    WithStyles
{
    ...
    {
        $controller = new ReportePieceRateReportController();
        return view('admin.reportes.exports.piece_rate_report_csv', [
            'data' => $controller->generarPieceRateReportData(
                collect($this->employees)->pluck('id')->toArray(),
                $this->initial_date,
                $this->final_date,
                $this->farms,
                $this->crops
