    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="mt-3">
                <div class="d-flex flex-col gap-2 align-items-center mb-2">
                    <h6>Add column</h6>
                    <select class="form-select" style="width: fit-content" id="dynamic-column-picker-select">
                    </select>
                </div>
                <h5>Columns</h5>
        ...
        <div class="col-md-12 mb-3">
            ...
            <div class="mt-3">
                <div class="d-flex flex-col gap-2 align-items-center mb-2">
                    <h6>Add group by</h6>
                    <select class="form-select" style="width: fit-content" id="dynamic-group-by-picker-select">
                    </select>
                </div>
                <h5>Groups</h5>
        ...
        <div class="col-md-12 pt-3">
            ...
            <select class="selectpicker w-100 selectpicker" data-style-base="btn color_principal" data-actions-box="true" name="cod_farm_reporte_hours"
                id="cod_farm_reporte_hours" multiple>
        ...
        <div class="col-md-12 pt-3">
            ...
            <select class="selectpicker w-100" data-style-base="btn color_principal" data-actions-box="true" name="cod_location_reporte_hours" id="cod_location_reporte_hours" multiple>
            </select>
        </div>
    ...
    <div class="mx-auto px-3" style="box-sizing: border-box">
        ...
        <div class="row w-100 m-2 d-none" id="heading_wrapper">
            <div class="col-12 mt-2">
                <div class="row border border-secondary rounded w-100 color_principal text-white" id="heading_columns">
