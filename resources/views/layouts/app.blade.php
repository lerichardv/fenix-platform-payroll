            ...
            <div class="d-flex justify-content-between w-100">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('employee_hours_location') }}">Employee hours per location Report</a></li>
                        <li><a class="dropdown-item" href="{{ route('piece_rate_report') }}">Harvest Piece Rate Report</a></li>
                        <li><a class="dropdown-item" href="{{ route('misc_piece_rate_report') }}">Misc Piece Rate Report</a></li>
                        <li><a class="dropdown-item" href="{{ route('location_executive_report') }}">Location Executive Report</a></li>
                        <li><a class="dropdown-item" href="{{ route('estimated_payroll') }}">Estimated Payroll Report</a></li>
                        <li><a class="dropdown-item" href="{{ route('dynamic_report') }}">Dynamic Report</a></li>
                        <li><a class="dropdown-item" href="{{ route('sing_sheets_report') }}">Sign Sheets Report</a></li>
                    </ul>
                </div>
