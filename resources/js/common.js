...
export function cargarSelectLocacionesPorGranja(id_select, cod_farm, oncomplete = null, incluirAll = true) {
	// let url = window.location.origin + '/public/api/v1/empleado_administracion/listaLocacionesPorGranjas';
...
export function cargarSelectLocacionesPorGranjasMultiple(id_select, cod_farm, oncomplete = null, incluirAll = true) {
	// let url = window.location.origin + '/public/api/v1/empleado_administracion/listaLocacionesPorGranjasMultiple';
