...
function generarReporte() {
	...
	$.ajax({
		type: "POST",
		// url: window.location.origin + "/public/api/v1/reportes/obtenerLocationExecutiveData",
...
function exportarArchivo(week, farms, locations, formato = 'xlsx') {
	...
	var form = $('<form>', {
		// action: window.location.origin + '/public/v1/empleado/exportLocationExecutiveSummary',  // URL del endpoint
