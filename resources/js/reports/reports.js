    ...
    data.forEach((usuario)=>{
        if(usuario.horas_trabajadas != 0){
            ...
            usuario.granjas.forEach((granja)=>{
                if(granja.horas_trabajadas != "00.00" && granja.horas_trabajadas != 0){
                    granjasCol += `
                        <div>
                            <b>${granja.farm}:</b> ${granja.horas_trabajadas}
                        </div>
                    `;
                    granja.locations.forEach((location)=>{
                        if(location.horas_trabajadas != "00:00" && location.horas_trabajadas != 0){
                            granjasCol += `
                                <div style="margin-left: 20px">
                                    <small><i>${location.location}: ${location.horas_trabajadas}</i></small>
                                </div>
                            `;
                        }
                    });
                ...
                <div class="col-12">
                    <div class="row w-100 border-bottom">
                        ...
                        <div class="col-3 px-3 py-2">
                            <span><b>Total: </b>${usuario.horas_trabajadas}</span> <br/>
                            <small><b>Hours: </b> ${usuario.horas_trabajadas_decimales}hrs</small>
                        </div>
                    </div>
                </div>
            `;
